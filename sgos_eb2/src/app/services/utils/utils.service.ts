...
// import { IAddress, IUserReduced } from "@app/interfaces/user";
import { StatusBar, Style } from '@capacitor/status-bar';
import { Capacitor } from "@capacitor/core";
import { IPlatformDevice } from "src/app/interfaces/platform-device";
import { LoadingPage } from "src/app/modals/loading/loading.page";
...
export class UtilsService {
  ...
  */
  ...
  //   this.openModal(
  //     ClientCreatedPage,
  //     this.screenWidth <= 765 ? 'client-created-mb' : 'client-created-dp',
  //     {},
  //     (props: ()=>{}) => {
  //     },
  //     false
